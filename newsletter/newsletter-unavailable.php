    ...
    <main>
        ...
        <section class="hero" id="hero-1">
            ...
            <div class="container hero-content">
                <div class="badge"><span class="badge-dot"></span><span>Notice</span></div>
                <h1>Not available</h1>
                <p>Sorry! The newsletter is not available on this page, but you can still explore other content on the site.</p>
            </div>
        </section>
