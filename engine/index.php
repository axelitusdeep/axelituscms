    ...
    <main>
        ...
        <section class="hero" id="hero-1">
            ...
            <div class="container hero-content">
                <div class="badge"><span class="badge-dot"></span><span>Your CMS Engine</span></div>
                <h1>Renderion Engine</h1>
                <p>This website is proudly powered and built using the Renderion Engine and the AxElitus CMS.</p>
            </div>
        </section>
